...
- [ ] 2. Módulo `bets_tracker.py` — lógica pura
  - [ ] 2.1 Criar o arquivo `bets_tracker.py` com constantes, helpers e exceção
  ...
  - [ ] 2.2 Escrever testes de Property 2 — cálculo de lucro
  ...
  - [ ] 2.3 Implementar `BetsTracker.__init__` e `registrar_alerta()`
  ...
  - [ ] 2.5 Implementar `marcar_apostou()`, `marcar_pulei()`, `marcar_resultado()`, `marcar_resultado_expirado()`
  ...
  - [ ] 2.7 Implementar métodos de lembrete: `get_pendentes_para_lembrete()`, `marcar_lembrete_enviado()`, `adiar_lembrete()`, `incrementar_tentativa_lembrete()`
  ...
  - [ ] 2.9 Implementar `expirar_alertas_antigos()` e métodos de consulta: `get_resumo()`, `get_pendentes()`, `get_historico()`, `get_bet_status()`
...
- [ ] 5. Modificações em `bot_ev.py` — templates e botões
  - [ ] 5.1 Adicionar imports e criar funções de template
  ...
  - [ ] 5.2 Criar `_montar_keyboard()` e atualizar `enviar_alerta()` e `enviar_alerta_instantaneo()`
...
- [ ] 6. Callbacks "Apostei" e "Pulei" + text handler em `bot_listener.py`
  - [ ] 6.1 Adicionar imports e instância global de `BetsTracker`
  ...
  - [ ] 6.2 Implementar `bet_yes_callback`
  ...
  - [ ] 6.3 Implementar `bet_no_callback`
  ...
  - [ ] 6.6 Registrar handlers `bet_yes_callback` e `bet_no_callback` no `ApplicationBuilder`
  ...
  - [ ] 6.7 Checkpoint manual — testar envio de alerta com botões e fluxo Apostei
...
- [ ] 7. Job de lembrete pós-jogo em `main_scheduler.py`
  - [ ] 7.0 Implementar funções auxiliares de formatação do lembrete
  ...
  - [ ] 7.1 Adicionar import e instância de `BetsTracker` em `BotScheduler.__init__`
    - Importar `BetsTracker` de `bets_tracker`
    - Instanciar `self.bets_tracker = BetsTracker(self.db)` no `__init__`
    - _Requirements: 12.1_

  - [ ] 7.2 Implementar `lembrete_pos_jogo_job()`
  ...
  - [ ] 7.3 Adicionar job ao `start()` com `IntervalTrigger(minutes=15)` e `max_instances=1`
    - Manter todos os jobs existentes sem modificação
    - _Requirements: 12.1, 12.5_

- [ ] 8. Callbacks de resultado em `bot_listener.py`
  - [ ] 8.1 Implementar `bet_result_win_callback`, `bet_result_loss_callback`, `bet_result_push_callback`
  ...
  - [ ] 8.2 Implementar `bet_cashout_callback`
  ...
  - [ ] 8.3 Implementar `bet_postpone_callback`
...
- [ ] 10. Comandos `/banca`, `/pendentes`, `/historico` em `bot_listener.py`
  - [ ] 10.1 Implementar `banca_command`
